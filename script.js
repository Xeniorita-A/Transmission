(function() {
  ...
  MESSAGES.push({
    delay: 6200,
    text: "Your presence has really brought good fortunes to me."
  });

  MESSAGES.push({
    delay: 8800,
    text: "Every moment we have spent together has been awesome."
  });

  MESSAGES.push({
    delay: 10400,
    text: "But I assure you, that the best is yet to come..."
  });

  MESSAGES.push({
    delay: 12000,
    text: "Thanks for loving me like you constantly do."
  });

  MESSAGES.push({
    delay: 13600,
    text: "Regardless of how bad my day has been, "
  });

  MESSAGES.push({
    delay: 15200,
    text: "You're always there to make me feel better."
  });

  MESSAGES.push({
    delay: 16800,
    text: "Forgive me, for I am not a writer, and may not know"
  });

  MESSAGES.push({
    delay: 18400,
    text: "the best way and best words to use."
  });

  MESSAGES.push({
    delay: 20000,
    text: "I just wanted to tell you how much I love you."
  });

  MESSAGES.push({
    delay: 21600,
    text: "Being with you still seem like a fairy tale. "
  });

  MESSAGES.push({
    delay: 23200,
    text: "Will there be a happy ever after?"
  });

  MESSAGES.push({
    delay: 24800,
    text: "I'm sure there will be."
  });
